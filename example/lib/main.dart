...
//                            _showDialog(context, "Hi");
                      ...
                      _buildDesc('通过简单的配置 text 以及 onPressed，即可构造一个可用 FButton\n'
                      ...
                      _buildDesc('你可以自由的配置 FButton 不可用状态下的样式\n'
                          '通过 disabledXXX 属性'),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(8, 0, 8, 0),
                        child: FButton(
                      ...
                      Padding(
                        ...
                        child: FButton(
                          ...
                          onPressed: () {},
                          clickEffect: true,
                          corner: FButtonCorner.all(12),
                        ),
                      ),
                      _buildDesc('你可以为 FButton 添加圆角，通过 corner 属性\n'
                          '甚至，你可以单独控制每一个圆角'),
                      Container(
                        width: 360,
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                FButton(
                                  ...
                                  clickEffect: true,
                                  corner: FButtonCorner(
                                      leftTopCorner: 25, leftBottomCorner: 25),
                                ),
                                FButton(
                                  effect: true,
                                  text: "Corner FButton",
                                  ...
                                  clickEffect: true,
                                  corner: FButtonCorner(
                                      leftTopCorner: 35, rightTopCorner: 35),
                                ),
                              ],
                            ),
                          ],
                      ...
                      _buildDesc('默认情况下，FButton 的边角为圆角\n'
                      ...
                      _buildMiddleMargin(),
                      _buildTitle("Custom Size & Gradient FButton"),
                      _buildSmallMargin(),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(8, 0, 8, 0),
                        child: FButton(
                      ...
                      _buildDesc("默认情况下，FButton 的宽将会尽可能的大。"
...
//                            ),
                      ...
                      _buildDesc("通过 gradient 属性，可以构建带有渐变色的 FButton\n"
                          "你可以自由构建多种类型的渐变色"),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(8, 0, 8, 0),
                        child: FButton(
                      ...
                      _buildMiddleMargin(),
                      _buildTitle("Image & Loading FButton"),
                      _buildSmallMargin(),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          FButton(
                            ...
                            clickEffect: true,
                            corner:
                            FButtonCorner(leftTopCorner: 25, leftBottomCorner: 25),
                            image: Icon(
                          ...
                          FButton(
                            ...
                            corner: FButtonCorner(
                                rightTopCorner: 25, rightBottomCorner: 25),
                            image: Icon(
                      ...
                      _buildDesc("image 属性能够为 FButton 设置一个图片\n"
                      ...
                      _buildDesc('如果按钮不需要背景，设置 "color: Colors.transparent" 即可\n'
                      ...
                      _buildDesc("通过 loading 属性，可为 FButton 配置 Loading 效果\n"
                      ...
                      StatefulBuilder(builder: (context, setState) {
                        return Column(
                          children: <Widget>[
                            ...
                            _buildDesc("通过 clickLoading 属性实现点击开始 loading 的效果\n"
                            ...
                            _buildDesc(
                                '当 "hideTextOnLoading: true" 时，如果 FButton 处于 loading 状态\n'
                                '那么其文本将会被隐藏起来'),
                            FButton(
                              width: 100,
                              text: "Reset",
                      ...
                      StatefulBuilder(builder: (context, setState) {
                        return Column(
                          children: <Widget>[
                            ...
                            _buildDesc("FButton 允许配置阴影的颜色、大小、以及位置\n"
                                "拖动滑块试试 🤠"),
                            Container(
                              width: 200,
                              child: Slider(
                                ...
                                inactiveColor:
                                    Color(0xffffc900).withOpacity(0.38),
                                onChanged: (v) {
                                  setState(() {
                                    _shadowBlur = v;
                                  });
